...
class Game(Scene):
    ...
    def __init__(self):
        ...
        self.current_level = Level(self.maps[self.stage], self)
...
class Level:
    def __init__(self, worldmap, game_scene):
        self.display = pygame.display.get_surface()
    ...
    def generate_map(self):
        for row_index, row in enumerate(self.worldmap):
            for col_index, col in enumerate(row):
                ...
                if col == 'X':
                    Obj("assets/palataforma-01.png",[x, y], [self.all_sprites,self.colision_sprites])
                elif col == 'Y':
                    Obj("assets/palataforma-02.png",[x, y], [self.all_sprites])
                elif col == 'C':
